...
Stephanie Alexander  
Double alumna, University of Chicago
...
> S. Alexander, "The Dimensional Origin of Newton's Constant,"  
> submitted to the Gravity Research Foundation Essay Competition (2026).
...
| `expanded_exclusion_test.py` | Figure 1 | Exclusion of 3,828 algebraic pairs against five simultaneous observables, with parasite analysis |
...
Or run everything in the browser: [Open in Colab](https://colab.research.google.com/drive/1phfIjwVv6QlORuEhcbRYe3XD4iw636bO)
